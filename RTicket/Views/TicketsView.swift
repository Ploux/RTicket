...
struct TicketsView: View {
    ...
    var body: some View {
        let filteredTickets = tickets.where { ticket in ticket.title.contains(searchText, options: .caseInsensitive) || ticket.details.contains(searchText, options: .caseInsensitive) }
